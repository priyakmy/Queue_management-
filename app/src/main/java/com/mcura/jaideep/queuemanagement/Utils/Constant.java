...
/**
 * Created by mCURA1 on 5/13/2016.
 */
public class Constant {
    ...
    public static String SUB_TANENT_IMAGE_PATH = "SubTanentImagePath";
    public static String USER_PROFILE_PIC = "user_profile_pic";
    public static String UNAME_KEY = "Uname";
    public static String SERVICE_ROLE_ID = "serviceRoleId";
    public static String DEPT_ID = "dept_id";
    public static String DEPT_NAME = "dept_name";
    public static String SUBTANENT_NAME = "subtanent_name";
    public static String SUBTANENT_ADD = "subtanent_add";
    public static String SUBTANENT_CONTACT = "subtanent_contact";
    public static String LOGIN_ROLE_ID = "RoleId";
}
