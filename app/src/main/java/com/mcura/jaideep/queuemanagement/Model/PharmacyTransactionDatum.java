...
public class PharmacyTransactionDatum {
    ...
    @SerializedName("pharmacySubtenant")
    @Expose
    private Integer pharmacySubtenant;
    ...
    public Integer getPharmacySubtenant() {
        return pharmacySubtenant;
    }

    public void setPharmacySubtenant(Integer pharmacySubtenant) {
        this.pharmacySubtenant = pharmacySubtenant;
    }
